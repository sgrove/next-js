export const EXAMPLE_PATH = 'with-auth-guardian'
export const CMS_NAME = 'AuthGuardian'
export const CMS_URL = 'https://www.onegraph.com/auth-guardian/'
...
export const ONE_GRAPH_APP_ID = process.env.ONE_GRAPH_APP_ID
export const ONE_GRAPH_SERVER_SIDE_ACCESS_TOKEN =
  process.env.ONE_GRAPH_SERVER_SIDE_ACCESS_TOKEN

export let AUTO_DETECTED_GITHUB_LINK =
  process.env.gitHubOrg && process.env.gitHubRepo
    ? `https://github.com/${process.env.gitHubOrg}/${process.env.gitHubRepo}`
    : null

export let GIT_CHECKOUT_LINK =
  process.env.gitHubOrg && process.env.gitHubRepo
    ? `git@github.com:${process.env.gitHubOrg}/${process.env.gitHubRepo}.git`
    : null

// Run https://serve.onegraph.com/short/DJ80ES to find the id of the repository
// you want to use to store feedback
export const FEEDBACK_REPO_ID = 'MDEwOlJlcG9zaXRvcnk3MDEwNzc4Ng=='
